...
namespace Azure.ResourceManager.Samples.Common
{
    public static class Utilities
    {
        ...
        public static void PrintAvailabilitySet(AvailabilitySetResource resource)
        {
            Utilities.Log(new StringBuilder().Append("Availability Set: ").Append(resource.Id)
                ...
                .Append("\n\tFault domain count: ").Append(resource.Data.PlatformFaultDomainCount)
                .Append("\n\tUpdate domain count: ").Append(resource.Data.PlatformUpdateDomainCount)
                .ToString());
        }
